...
public final class MD5 {
    ...
    public static String md5for32(byte[] byteArray) {
        // 返回字符串
        String md5Str = null;
        try {
            // 操作字符串
    ...
    public static String md5for16(byte[] byteArray) {
        return MD5.md5for32(byteArray).substring(8, 24);
    }

    public static String md5for32(String plainText) {
        return md5for32(plainText.getBytes());
    }

    public static String md5for16(String plainText) {
        return MD5.md5for32(plainText).substring(8, 24);
    }
}